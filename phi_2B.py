...
# json_file_path = "./FollowUp/greedy/phi_2_senator_greedy_followup.json"
...
for temp in [0.6]:
    ...
    for item in questions:
        ...
        number = item["number"]
        # question = f"{base_question} Directly answer this question."
    ...
    output_file_path = f"./Answers/phi_2_primality_greedy_fs.json"
    # output_file_path = f"./Answers/phi_2_primality_greedy.json"
    # output_file_path = f"./Answers/phi_2_arithmetic_t{str(temp).replace('.', '')}.json"
    # output_file_path = f"./Answers/phi_2_arithmetic_b{str(beam)}.json"

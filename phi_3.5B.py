...
output_file_path = "./Answers/primality_answers.txt"
with open(output_file_path, "w") as output_file:
    for item in questions:
        ...
        question = f"{base_question} Firstly you should answer yes or no. If your answer is no, on the second line give me explaination in one sentence."

...
# json_file_path = "./FollowUp/phi_1_senator_greedy_followup.json"
...
for temp in [0.1]:
    ...
    for item in questions:
        ...
        # question = f"{item} Directly answer this question with yes or no."
    ...
    # output_file_path = f"./Answers/phi_1_primality_greedy.json"
    output_file_path = f"./Answers/phi_1_primality_greedy_fs.json"
    # output_file_path = f"./Answers/phi_1_senator_FU_t{str(temp).replace('.', '')}.json"
    # output_file_path = f"./Answers/phi_1_arithmetic_b{str(beam)}.json"
